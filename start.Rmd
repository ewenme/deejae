...
welcome to **deejae**, an ongoing open-source effort to help digital DJs explore and understand their DJ sets. native support is currently provided for [Traktor](https://www.native-instruments.com/en/products/traktor/) only. [e-mail me](ewenhenderson@gmail.com) with feedback/enquiries/etc.

**navigation basics**

all functionality is located in the **app** tab, accessed from the navbar above. come back here to learn more about the project, or whenever you need some help working the app.

**uploading your traktor history**
